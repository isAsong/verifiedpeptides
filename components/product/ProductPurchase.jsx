    ...
    return (
        <div className="mt-6">
            <a
                ...
                className="inline-flex items-center justify-center w-full px-6 py-4 bg-green-600 text-white font-semibold text-lg rounded-lg hover:bg-green-700 transition-colors"
            >
                ...
                Contact via WhatsApp for Inquiry
            </a>
